...
for(const feature of ["bindFiles","renderTaskSwitcher","data-wallpaper","SKIP_WAITING","updateSearch","finish-onboarding","systemLog"]){assert.ok(js.includes(feature),`missing feature ${feature}`);}
