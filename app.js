...
function aboutHTML(){ return `<main class="app-content"><div class="about-logo"><div class="brand-mark">ن</div><h2>NourBest OS 2.1</h2><p>مساحة عمل عربية هجينة تعمل كتطبيق PWA على المنصات المقيدة، وكواجهة محلية مستضافة داخل إصدار Nour Linux القابل للبناء للحواسيب.</p><table class="spec-table"><tr><td>الإصدار</td><td>2.1 Universal</td></tr><tr><td>الواجهة</td><td>Nour Shell</td></tr><tr><td>الملفات</td><td>محلية مع استيراد وتصدير</td></tr><tr><td>الاتصال</td><td>يعمل دون إنترنت</td></tr><tr><td>الترخيص</td><td>MIT</td></tr></table></div></main>`; }
